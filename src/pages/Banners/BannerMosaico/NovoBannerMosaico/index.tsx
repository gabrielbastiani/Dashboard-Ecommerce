...
const NovoBannerMosaico: React.FC = () => {
    ...
    async function handleBanner(event: FormEvent) {
        ...
        try {
            ...
            await apiClient.post(`/createBannerMosaico`, data);
        ...
        <Grid>
            ...
            <Container>
                <Card style={{ height: '850px' }}>
                    <Voltar url={'/banners/bannerMosaico'} />

                    <BlockTop>
                        <Titulos
                            tipo="h1"
                            titulo="Novo Banner para Mosaico"
                        />
                        <Button
                            type="submit"
                            style={{ backgroundColor: 'green' }}
                            form="form-bannerMosaico"
                        >
                            Salvar
                        </Button>
                    </BlockTop>
                    ...
                    <FormBanner id="form-bannerMosaico" onSubmit={handleBanner}>
                        <EtiquetaBannerInsert>
                            <IconSpan>
...
export default NovoBannerMosaico;